...
" Decorator support, single-: Evan Pierce Rosson
"
set ai
...
function! PythonFoldText()
  ...
  while getline(lnum) =~ '^\s*@.*'
    let line = line.getline(lnum)
    let lnum = lnum+1
  endwhile
  let line = line.getline(lnum)
  "let line = line.getline(v:foldstart)
...
function! GetPythonFold(lnum)
    ...
    "if nnum == a:lnum + 1
    "   ...uhh, why? Seems to work fine this way too. 
    if nnum == a:lnum
	return "="
    endif
